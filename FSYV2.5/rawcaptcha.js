...
if (process.argv.length < 6) {
    console.log("\x1b[31mUsage: node rawcaptcha.js <target> <time> <rate> <threads> <cookieCount>\x1b[0m");
    console.log("\x1b[33mExample: node rawcaptcha.js https://example.com 500 3000 3 2\x1b[0m");
    process.exit(1);
}
